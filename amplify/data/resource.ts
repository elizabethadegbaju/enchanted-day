...
const schema = a.schema({
  ...
  // Phase Budget (referenced in WeddingPhase)
  ...
  // Phase Timeline (referenced in WeddingPhase)
  PhaseTimeline: a.customType({
    timeline: a.ref("TimelineInfo"),
    milestones: a.string().array(),
    deadlines: a.string().array(),
  }),

  // Enhanced Wedding Phase - now as separate model for better querying
  WeddingPhase: a
    .model({
      ...
      milestones: a.hasMany("Milestone", "phase_id"),
      tasks: a.hasMany("Task", "phase_id"),
    })
  ...
  Task: a
    .model({
      ...
      wedding: a.belongsTo("Wedding", "wedding_id"),
      phase_id: a.id(),
      phase: a.belongsTo("WeddingPhase", "phase_id"),
